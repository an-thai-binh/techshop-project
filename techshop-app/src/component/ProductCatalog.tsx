...
export default function ProductCatalog(_props: ProductCatalogProps) {
  ...
  return (
    <div
      ref={catalogRef}
      className={`absolute ${_props.className} z-20 hidden h-[42vh] w-full flex-col items-start gap-2 border-r-2 border-none border-gray-300/10 bg-gray-300/90 px-2 py-1 text-black shadow-md backdrop-blur-md dark:border-gray-900/10 dark:bg-gray-800/90 dark:text-white sm:hidden md:hidden lg:hidden xl:flex`}
    >
