...
export default function UpdateCategoryForm({ id, categoryName, categoryImgUrl }: UpdateCategoryFormProps) {
            ...
            <div className="grid grid-cols-1">
                {success ?
                    <div className="mt-3 py-1 px-2 bg-green-100 w-fit mx-auto rounded-sm">
                        <p className="text-center font-bold text-green-500">Cập nhật thể loại thành công</p>
                    </div>
                    :
                    formErrorMessage &&
                    <div className="mt-3 py-1 px-2 bg-red-100 w-fit mx-auto rounded-sm">
                        <p className="ext-center font-bold text-red-500">Lỗi khi cập nhật thể loại: {formErrorMessage}</p>
                    </div>}
                <div className="m-3">
