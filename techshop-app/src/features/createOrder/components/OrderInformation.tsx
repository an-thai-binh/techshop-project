    ...
    useEffect(() => {
        watch((value) => {
            for (const key in value) {
                dispatch(updateInformation({ field: key as keyof OrderInformationType, value: value[key as keyof FormData] ?? "" }));
            }
        });
    }, [watch, dispatch])
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="space-y-6 lg:order-1 lg:col-span-2">
                ...
                <div className="bg-white p-3 shadow-sm">
                    ...
                    {errors.orderName && <span className="ms-1 text-sm font-medium text-red-500">{errors.orderName.message}</span>}
                </div>
                <div className="bg-white p-3 shadow-sm">
                    ...
                    {errors.orderEmail && <span className="ms-1 text-sm font-medium text-red-500">{errors.orderEmail.message}</span>}
                </div>
                <div className="bg-white p-3 shadow-sm">
                    ...
                    {errors.orderPhoneNumber && <span className="ms-1 text-sm font-medium text-red-500">{errors.orderPhoneNumber.message}</span>}
                </div>
                <div className="bg-white p-3 shadow-sm">
